<section class="py-5 bg-cover bg-gray">
    <div class="container py-5">
        ...
        <p class="lead my-4">Feel free to contact us if you have any queries by using the details below. Also do share your valuable feedback.</p>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="row">
                    <div class="col-lg-12 col-md-6 mb-4">
                        ...
                        <p class="text-muted mb-0 text-small">Kattigenahalli, <strong>Bangalore </strong></p>
                    </div>
                    <div class="col-lg-12 col-md-6 mb-4">
                        <div class="icon mb-4"><i class="pe-7s-phone"></i></div>
                        <h5 class="lined mb-4">Call center</h5>
                        <p class="text-muted mb-3 text-small">Office number</p>
                        <p class="text-muted font-weight-bold">080 4696 6966</p>
                    </div>
                    <div class="col-lg-12 col-md-6 mb-4">
                        ...
                        <ul>
                            <li><a href="#" class="font-weight-bold text-small">contactforhelp@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-lg-7 ml-auto">
                <div class="col-lg-12 col-md-6 mb-4">
                    ...
                    <h5 class="lined mb-4">Feedback form</h5>
                    <p class="text-muted text-small">Help us to improve ourselves by sharing your experience. Let us know if you guys enjoyed being here!</p>
