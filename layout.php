    ...
    <div class="container py-5">
      <div class="row">
        <div class="col-lg-8 col-md-6 mb-4">
          ...
          <p class="text-muted text-small">Our Zoo Management System is designed to transform the way zoos operate, integrating technology to ensure optimal animal care and facility management. This comprehensive platform automates routine tasks such as feeding schedules, medical records, and habitat maintenance, allowing zookeepers to focus more on animal welfare. It offers real-time monitoring and data analytics to track animal health and behavior, enabling proactive interventions. The system also enhances visitor experiences through interactive maps, educational content, and streamlined ticketing.</p>
          <p class="text-muted text-small">With robust reporting features, it supports informed decision-making and regulatory compliance. Designed with user-friendly interfaces, it ensures accessibility for staff at all levels. Our Zoo Management System is committed to advancing conservation efforts, enhancing operational efficiency, and fostering a deeper connection between humans and wildlife.</p>
        </div>
        <div class="col-lg-4 col-md-6 mb-4">
          <h5 class="lined lined-dark mb-3 color-header">Our Location</h5>
          <h6>Zoo Management System</h6>
          <p class="text-muted mb-0 text-small">Swami Vivekananda block</p>
          <p class="text-muted mb-0 text-small">REVA University</p>
          <p class="text-muted mb-4 text-small">080 7777 8787</p>
        </div>
        <div class="col-lg-4 col-md-6 mb-4">
